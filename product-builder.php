...
define('PRINTCART_PB_UPLOAD_DIR',               $basedir . '/printcart-product-builder');
define('PRINTCART_PB_UPLOAD_URL',               $baseurl . '/printcart-product-builder');
define('PRINTCART_PB_DATA_URL',                 PRINTCART_PB_PLUGIN_URL . 'data/');
define('PRINTCART_PB_DATA_DIR',                 PRINTCART_PB_PLUGIN_DIR . 'data/');
define('PRINTCART_PB_FONT_URL',                 PRINTCART_PB_UPLOAD_URL . '/fonts');
define('PRINTCART_PB_FONT_DIR',                 PRINTCART_PB_UPLOAD_DIR . '/fonts');
define('PRINTCART_PB_CUSTOMER_DIR',             PRINTCART_PB_UPLOAD_DIR . '/designs');
define('PRINTCART_PB_CUSTOMER_URL',             PRINTCART_PB_UPLOAD_DIR . '/designs');
