            ...
            <div ng-repeat="(opIndex, op) in field.general.attributes.options" class="nbd-attribute-wrap">
                <div ng-show="op.isExpand" class="nbd-attribute-img-wrap">
                    ...
                    <div class="nbd-attribute-img-inner" ng-show="op.preview_type == 'i'">
                        ...
                        <img title="<?php esc_html_e('Click to change image', 'pc-product-builder'); ?>" ng-click="set_attribute_image(fieldIndex, $index, 'image', 'image_url')" ng-src="{{op.image != 0 ? op.image_url : '<?php echo PRINTCART_PB_ASSETS_URL . 'images/placeholder.png' ?>'}}" />
                    </div>
                    ...
                    <div ng-if="field.appearance.change_image_product.value == 'y'">
                        ...
                        <div class="nbd-attribute-img-inner">
                            ...
                            <img title="<?php esc_html_e('Click to change image', 'pc-product-builder'); ?>" ng-click="set_attribute_image(fieldIndex, $index, 'product_image', 'product_image_url')" ng-src="{{op.product_image_url ? op.product_image_url : '<?php echo PRINTCART_PB_ASSETS_URL . 'images/placeholder.png' ?>'}}" />
                        </div>
                    </div>
                </div>
                        ...
                        <div ng-repeat="(sopIndex, sop) in op.sub_attributes" class="nbd-subattributes-wrap">
                            <div ng-show="sop.isExpand" class="nbd-attribute-img-wrap">
                                ...
                                <div class="nbd-attribute-img-inner" ng-show="sop.preview_type == 'i'">
                                    ...
                                    <img title="<?php esc_html_e('Click to change image', 'pc-product-builder'); ?>" ng-click="set_sub_attribute_image(fieldIndex, opIndex, sopIndex)" ng-src="{{sop.image != 0 ? sop.image_url : '<?php echo PRINTCART_PB_ASSETS_URL . 'images/placeholder.png' ?>'}}" />
                                </div>
