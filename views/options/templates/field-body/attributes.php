...
<div class="pcpb-field-info" ng-show="check_depend(field.general, field.general.attributes)">
    <div class="pcpb-field-info-1">
        <div><label><b><?php esc_html_e('Attributes', 'storelly-product-builder-for-woocommerce'); ?></b> <nbd-tip data-tip="<?php esc_html_e('Attributes let you define extra product data, such as size or color.', 'storelly-product-builder-for-woocommerce'); ?>"></nbd-tip></label></div>
    </div>
        ...
        <div>
            <div ng-repeat="(opIndex, op) in field.general.attributes.options" class="nbd-attribute-wrap">
                <div ng-show="op.isExpand" class="nbd-attribute-img-wrap">
                    <div><?php esc_html_e('Swatch type', 'storelly-product-builder-for-woocommerce'); ?></div>
                    <div>
                    ...
                    <div class="nbd-attribute-img-inner" ng-show="op.preview_type == 'i'">
                        ...
                        <img title="<?php esc_html_e('Click to change image', 'storelly-product-builder-for-woocommerce'); ?>" ng-click="set_attribute_image(fieldIndex, $index, 'image', 'image_url')" ng-src="{{op.image != 0 ? op.image_url : '<?php echo esc_url(SPBWC_PB_ASSETS_URL . 'images/placeholder.png'); ?>'}}" />
                    </div>
                    ...
                    <div ng-if="field.appearance.change_image_product.value == 'y'">
                        <div><?php esc_html_e('Product image', 'storelly-product-builder-for-woocommerce'); ?></div>
                        <div class="nbd-attribute-img-inner">
                            ...
                            <img title="<?php esc_html_e('Click to change image', 'storelly-product-builder-for-woocommerce'); ?>" ng-click="set_attribute_image(fieldIndex, $index, 'product_image', 'product_image_url')" ng-src="{{op.product_image_url ? op.product_image_url : '<?php echo esc_url(SPBWC_PB_ASSETS_URL . 'images/placeholder.png'); ?>'}}" />
                        </div>
                    </div>
                </div>
                <div ng-show="op.isExpand" class="nbd-attribute-content-wrap">
                    <div><?php esc_html_e('Title', 'storelly-product-builder-for-woocommerce'); ?></div>
                    <div class="nbd-attribute-name">
                        ...
                        <label><input type="checkbox" name="options[fields][{{fieldIndex}}][general][attributes][options][{{$index}}][selected]" ng-checked="op.selected" ng-click="seleted_attribute(fieldIndex, 'attributes', $index)" /> <?php esc_html_e('Default', 'storelly-product-builder-for-woocommerce'); ?></label>
                    </div>
                    <div class="nbd-margin-10"></div>
                    <div><?php esc_html_e('Description', 'storelly-product-builder-for-woocommerce'); ?></div>
                    <div class="nbd-attribute-name">
                        <textarea placeholder="<?php esc_html_e('Description', 'storelly-product-builder-for-woocommerce'); ?>" value="{{op.des}}" ng-model="op.des" name="options[fields][{{fieldIndex}}][general][attributes][options][{{opIndex}}][des]"></textarea>
                    </div>
                    <div class="nbd-margin-10"></div>
                    <div><?php esc_html_e('Price', 'storelly-product-builder-for-woocommerce'); ?></div>
                    <div>
                        <div><?php esc_html_e('Additional Price', 'storelly-product-builder-for-woocommerce'); ?></div>
                        <div>
                    ...
                    <div class="nbd-enable-subattribute" ng-hide="field.nbd_type != '' && field.nbd_type != null">
                        <label><input ng-click="toggle_enable_subattr(fieldIndex, $index)" type="checkbox" name="options[fields][{{fieldIndex}}][general][attributes][options][{{$index}}][enable_subattr]" ng-true-value="'on'" ng-false-value="'off'" ng-model="op.enable_subattr" ng-checked="op.enable_subattr" /> <?php esc_html_e('Enable sub attributes', 'storelly-product-builder-for-woocommerce'); ?></label>
                    </div>
                    <div class="nbd-margin-10"></div>
                    <div class="nbd-subattributes-wrapper" ng-if="op.enable_subattr === true || op.enable_subattr == 'on'">
                        <div class="pcpb-field-info">
                            <div class="pcpb-field-info-1">
                                <div><label><b><?php esc_html_e('Sub attributes type', 'storelly-product-builder-for-woocommerce'); ?></b></label></div>
                            </div>
                            <div class="pcpb-field-info-2">
                                <div>
                        ...
                        <div ng-repeat="(sopIndex, sop) in op.sub_attributes" class="nbd-subattributes-wrap">
                            <div ng-show="sop.isExpand" class="nbd-attribute-img-wrap">
                                ...
                                <div class="nbd-attribute-img-inner" ng-show="sop.preview_type == 'i'">
                                    ...
                                    <img title="<?php esc_html_e('Click to change image', 'storelly-product-builder-for-woocommerce'); ?>" ng-click="set_sub_attribute_image(fieldIndex, opIndex, sopIndex)" ng-src="{{sop.image != 0 ? sop.image_url : '<?php echo esc_url(SPBWC_PB_ASSETS_URL . 'images/placeholder.png'); ?>'}}" />
                                </div>
                            ...
                            <div ng-show="sop.isExpand" class="nbd-attribute-content-wrap">
                                ...
                                <div class="nbd-attribute-name">
                                    ...
                                    <label><input type="checkbox" name="options[fields][{{fieldIndex}}][general][attributes][options][{{opIndex}}][sub_attributes][{{sopIndex}}][selected]" ng-checked="sop.selected" ng-click="seleted_sub_attribute(fieldIndex, 'attributes', opIndex, sopIndex)" /> <?php esc_html_e('Default', 'storelly-product-builder-for-woocommerce'); ?></label>
                                </div>
                                <div class="nbd-margin-10"></div>
                                <div><?php esc_html_e('Description', 'storelly-product-builder-for-woocommerce'); ?></div>
                                <div class="nbd-attribute-name">
                                    <textarea placeholder="<?php esc_html_e('Description', 'storelly-product-builder-for-woocommerce'); ?>" value="{{sop.des}}" ng-model="sop.des" name="options[fields][{{fieldIndex}}][general][attributes][options][{{opIndex}}][sub_attributes][{{sopIndex}}][des]"></textarea>
                                </div>
                                <div><?php esc_html_e('Price', 'storelly-product-builder-for-woocommerce'); ?></div>
                                <div>
                                    <div><?php esc_html_e('Additional Price', 'storelly-product-builder-for-woocommerce'); ?></div>
                        ...
                        <div><a class="button" ng-click="add_sub_attribute(fieldIndex, opIndex)"><span class="dashicons dashicons-plus"></span> <?php esc_html_e('Add sub attribute', 'storelly-product-builder-for-woocommerce'); ?></a></div>
                        <div class="nbd-margin-10"></div>
                    </div>
                </div>
            ...
            <div><a class="button" ng-click="add_attribute(fieldIndex, 'attributes')"><span class="dashicons dashicons-plus"></span> <?php esc_html_e('Add attribute', 'storelly-product-builder-for-woocommerce'); ?></a></div>
        </div>
    </div>
</div>
<?php echo '</script>';
