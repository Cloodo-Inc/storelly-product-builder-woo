...
<div class="pcpb-field-wrap" ng-repeat="(fieldIndex, field) in options.fields" id="{{field.id}}">
    <div class="nbd-nav">
        <div ng-dblclick="toggleExpandField($index, $event)" style="cursor: pointer;" title="<?php esc_html_e('Double click to expand option', 'storelly-product-builder-for-woocommerce') ?>">
            ...
            <span class="nbstorelly-right field-action">
                ...
                <span class="nbo-sort-group">
                    <span ng-click="sort_field($index, 'up')" class="dashicons dashicons-arrow-up nbo-sort-up nbo-sort" title="<?php esc_html_e('Up', 'storelly-product-builder-for-woocommerce') ?>"></span>
                    <span ng-click="sort_field($index, 'down')" class="dashicons dashicons-arrow-down nbo-sort-down nbo-sort" title="<?php esc_html_e('Down', 'storelly-product-builder-for-woocommerce') ?>"></span>
                </span>
                <a class="pcpb-field-btn nbd-mini-btn button" ng-click="delete_field($index)" title="<?php esc_html_e('Delete', 'storelly-product-builder-for-woocommerce'); ?>"><span class="dashicons dashicons-no-alt"></span></a>
                <a class="pcpb-field-btn nbd-mini-btn button" ng-click="copy_field($index)" title="<?php esc_html_e('Copy', 'storelly-product-builder-for-woocommerce'); ?>"><span class="dashicons dashicons-admin-page"></span></a>
                <a class="pcpb-field-btn nbd-mini-btn button" ng-click="toggleExpandField($index, $event)" title="<?php esc_html_e('Expand', 'storelly-product-builder-for-woocommerce'); ?>"><span ng-show="!field.isExpand" class="dashicons dashicons-arrow-down"></span><span ng-show="field.isExpand" class="dashicons dashicons-arrow-up"></span></a>
            </span>
        </div>
        <div class="clear"></div>
    </div>
...
<div style="display: flex; justify-content: space-between;">
    <a style="background: rgba(170, 0, 0, 0.75);color: #fff;border-color: rgba(170, 0, 0, 0.75);" class="button" ng-click="clear_all_fields()"><span class="dashicons dashicons-no-alt"></span> <?php esc_html_e('Clear All Fields', 'storelly-product-builder-for-woocommerce'); ?></a>
    <a class="button button-primary" ng-click="add_field()"><span class="dashicons dashicons-plus"></span> <?php esc_html_e('Add Field', 'storelly-product-builder-for-woocommerce'); ?></a>
</div>
<?php
