...
VI_EXTRA = {
    ...
    # Extended coverage — admin verbs, statuses, list/grid views, marketplace, quote-to-cash
    "Add new": "Thêm mới", "Add Note": "Thêm ghi chú",
    "Add color": "Thêm màu", "Add field": "Thêm trường", "Add Field": "Thêm trường",
    "Add view": "Thêm view", "Add View": "Thêm view",
    "Approve": "Duyệt", "Approved": "Đã duyệt", "Approvals": "Phê duyệt",
    "Reject": "Từ chối", "Rejected": "Đã từ chối",
    "Applying…": "Đang áp dụng…", "Updating…": "Đang cập nhật…",
    "Saving…": "Đang lưu…", "Loading…": "Đang tải…",
    "Renamed.": "Đã đổi tên.",
    "Connected": "Đã kết nối", "Disconnected": "Đã ngắt kết nối",
    "Created": "Đã tạo", "Modified": "Đã sửa",
    "Notice": "Thông báo",
    "Designer": "Designer", "Designers": "Designers",
    "Dashboard": "Bảng điều khiển",
    "My store": "Cửa hàng của tôi", "My Quotes": "Báo giá của tôi",
    "Sections": "Phần", "Subject": "Chủ đề",
    "Username": "Tên đăng nhập",
    "Quote": "Báo giá", "Quotes": "Báo giá",
    "Withdraw": "Rút tiền", "Withdraws": "Rút tiền",
    "Withdraw request": "Yêu cầu rút tiền",
    "Move up": "Lên", "Move down": "Xuống",
    "Sort by": "Sắp xếp theo",
    "Clear all": "Xóa hết", "Check all": "Chọn hết",
    "List view": "Dạng danh sách", "Card view": "Dạng thẻ",
    "Grid view": "Dạng lưới", "View mode": "Chế độ xem",
    "Next page": "Trang sau", "Per page:": "Mỗi trang:",
    "View name": "Tên view", "View base": "Nền view",
    "Side name": "Tên mặt",
    "Component": "Thành phần", "Components": "Các thành phần",
    "Data type": "Loại dữ liệu", "Display": "Hiển thị",
    "Drafts": "Bản nháp",
    "Stepper": "Bộ tăng giảm",
    "Dropdown": "Dropdown", "Textarea": "Vùng văn bản",
    "Long text": "Văn bản dài",
    "Simple": "Đơn giản", "Variable": "Biến thể",
    "Grouped": "Nhóm", "External": "Bên ngoài",
    "In Stock": "Còn hàng", "Catalog": "Catalog",
    "Featured": "Nổi bật",
    "Cancelled": "Đã hủy", "Completed": "Đã hoàn tất",
    "Requested": "Đã yêu cầu", "On-hold": "Tạm giữ",
    "Editable": "Có thể sửa",
    "Complete!": "Hoàn tất!", "Success!": "Thành công!",
    "Error!": "Lỗi!", "Error:": "Lỗi:",
    "Warning.": "Cảnh báo.", "Status:": "Trạng thái:",
    "Balance": "Số dư", "Revenue": "Doanh thu",
    "Payment": "Thanh toán", "Payments": "Thanh toán",
    "Method": "Phương thức", "API Keys": "Khóa API",
    "Min size": "Cỡ tối thiểu", "Max size": "Cỡ tối đa",
    "From qty": "Từ số lượng",
    "Zoom in": "Phóng to", "Zoom out": "Thu nhỏ",
    "Rotate": "Xoay", "Content": "Nội dung",
    "Get Quote": "Lấy báo giá", "Apply to": "Áp dụng cho",
    "Site URL": "URL website", "Home URL": "URL trang chủ",
    "Timezone": "Múi giờ",
    "Popular": "Phổ biến",
    "Active Plugins": "Plugin đang bật",
    "Changelog": "Nhật ký thay đổi",
    "Joined": "Đã tham gia",
    "Option ID": "ID tùy chọn",
    "Show when": "Hiện khi",
    "equals": "bằng", "contains": "chứa",
    "Choose": "Chọn", "Combine": "Gộp",
    "Re-scan": "Quét lại",
    "+ Options": "+ Tùy chọn",
    "No Option": "Không có tùy chọn", "No option": "không có tùy chọn",
    "All fonts": "Tất cả font", "Font name": "Tên font",
    "Tablet": "Máy tính bảng", "Mobile": "Di động", "Desktop": "Máy tính",
    "Secret": "Khóa bí mật",
    "Message": "Tin nhắn", "Message:": "Tin nhắn:",
    "Disabled": "Đã tắt", "Enabled": "Đã bật",
    "Pricing": "Định giá", "Builder": "Trình dựng",
    "Designs": "Thiết kế",
    "no logs": "không có log",
