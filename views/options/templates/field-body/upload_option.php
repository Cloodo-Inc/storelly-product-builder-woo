...
<div class="pcpb-field-info" ng-show="check_depend(field.general, field.general.upload_option)">
    <div class="pcpb-field-info-1">
        <div><label><b><?php esc_html_e('Upload file option', 'spbwc-product-builder'); ?></b></label></div>
    </div>
    <div class="pcpb-field-info-2">
        <div>
            <table class="nbd-table">
                <tr>
                    <th><?php esc_html_e('Min size', 'spbwc-product-builder'); ?></th>
                    <th><?php esc_html_e('Max size', 'spbwc-product-builder'); ?></th>
                    <th><?php esc_html_e('Allow type', 'spbwc-product-builder'); ?></th>
                </tr>
                <tr>
                    <td>
