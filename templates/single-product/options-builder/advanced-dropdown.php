...
<div nbo-adv-dropdown class="nbd-option-field pcpb-field-ad-dropdown-wrap <?php echo ($class); ?>" data-id="<?php echo ($field['id']); ?>" ng-if="nbd_fields['<?php echo ($field['id']); ?>'].enable">
    ...
    <div class="pcpb-field-content">
        <div>
            ...
            <div class="nbo-invalid-option" ng-class="nbd_fields['<?php echo ($field['id']); ?>'].valid === false ? 'active' : ''" ng-if="nbd_fields['<?php echo ($field['id']); ?>'].valid === false">{{nbd_fields['<?php echo ($field['id']); ?>'].invalidOption}} <?php esc_html_e('is not available', 'web-to-print-online-designer'); ?>
            </div>
        </div>
    </div>
</div>