...
<div class="pcpb-field-info">
    <div class="pcpb-field-info-1">
        <div><label><b><?php esc_html_e('Enabled', 'spbwc-product-builder'); ?></b> <nbd-tip data-tip="<?php esc_html_e('Choose whether the option is enabled or not.', 'spbwc-product-builder'); ?>"></nbd-tip></label></div>
    </div>
