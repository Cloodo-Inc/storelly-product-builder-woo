...
?>
<h2><?php esc_html_e('Google Fonts', 'spbwc-product-builder'); ?></h2>
        ...
        <div class="inside">
            ...
            <div class="gg-font-option">
                ...
                <select ng-model="filterFont.category" ng-change="resetCurentPage()">
                    <option value=""><?php esc_html_e('All Categories', 'spbwc-product-builder'); ?></option>
                ...
                <select ng-model="filterFont.subset" ng-change="resetCurentPage()">
                    <option value=""><?php esc_html_e('All subsets', 'spbwc-product-builder'); ?></option>
                    <?php
                ...
                <a class="button button-primary" ng-click="updateGoogleFont($event)"><?php esc_html_e('Update', 'spbwc-product-builder'); ?></a>
            </div>
            <div class="gg-font-preview-wrap">
                <div class="storelly-pagesize-wrap">
                    <b><?php esc_html_e('Total', 'spbwc-product-builder'); ?> {{fonts.length}} <?php esc_html_e('fonts', 'spbwc-product-builder'); ?></b>
                    <a class="button" ng-click="selectAll()"><?php esc_html_e('Select All', 'spbwc-product-builder'); ?></a>
                    <a class="button" ng-click="unselectAll()"><?php esc_html_e('Unselect All', 'spbwc-product-builder'); ?></a>
                    <div style="display: inline-block; float: right;">
                        <label for='nbd-selected'><?php esc_html_e('Display ', 'spbwc-product-builder'); ?></label>
                        <select id='nbd-selected' ng-model="filterFont.select" ng-change="resetCurentPage()">
                            <option value=""><?php esc_html_e('All', 'spbwc-product-builder'); ?></option>
                            <option value="selected"><?php esc_html_e('Selected', 'spbwc-product-builder'); ?></option>
                            <option value="unselected"><?php esc_html_e('Unselected', 'spbwc-product-builder'); ?></option>
                        </select>
                        <label for='nbd-page-size'><?php esc_html_e('Display ', 'spbwc-product-builder'); ?></label>
                ...
                <p><small><?php esc_html_e('Click check mark to select/unselect font', 'spbwc-product-builder'); ?></small></p>
                <p class="storelly-admin-font-warning"><?php esc_html_e('Please remove unused fonts to make the design editor loads faster', 'spbwc-product-builder'); ?></p>
                    ...
                    <div class="gg-font-preview" ng-click="selectFont( font, $event )" ng-repeat="font in fonts | startFrom:filterFont.currentPage*filterFont.pageSize | limitTo:filterFont.pageSize">
                        <div class="gg-font-preview-inner-wrap" style="font-family: '{{font.family}}',-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen-Sans, Ubuntu, Cantarell, 'Helvetica Neue', sans-serif">
                            <div class="gg-font-preview-inner">
                                ...
                                <span title="{{font.selected ? '<?php esc_html_e('Unselect', 'spbwc-product-builder'); ?>' : '<?php esc_html_e('Select', 'spbwc-product-builder'); ?>'}}" ng-class="font.selected ? '' : 'uncheck'" class="action dashicons dashicons-yes disable"></span>
                            </div>
                        </div>
                    </div>
                </div>
