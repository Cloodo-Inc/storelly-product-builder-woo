  ...
  .controller(
    ...
    function (
      ...
      $scope.remove_view_config_image = function (
        ...
        $scope.options["fields"][fieldIndex]["general"]["pb_config"][
          attr_index
        ][sattr_index].views[$index].image = 0;
        $scope.options["fields"][fieldIndex]["general"]["pb_config"][
          attr_index
        ][sattr_index].views[$index].image_url = "";
      };
      ...
      $scope.sort_field = function (field_index, direction) {
        ...
        $timeout(function () {
          ...
          $timeout(function () {
            ...
            jQuery.each(
              jQuery("[nbd-tab]").find(".nbd-field-tab"),
              function () {
                jQuery(this).on("click", function () {
                  var target = jQuery(this).data("target");
                  jQuery(this)
                    .parents(".nbd-field-wrap")
                    .find(".nbd-field-content")
                    .removeClass("active");
      ...
      $scope.initfieldValue = function () {
        angular.forEach($scope.options.fields, function (field, key) {
          $scope.option_values[key] = angular.isDefined(
      ...
      $scope.buildPbConfigFlat = function (field) {
        ...
        function build_config(
          ...
          field.general.pb_config[attr_index][sattr_index].sattr_index =
            sattr_index;
          field.general.pb_config[attr_index][sattr_index].has_sattr =
            has_sattr;
          if (
            angular.isUndefined(
      ...
      $scope.update_options_media = function (options) {
        ...
        function merge_new_media() {
          var new_options = $scope.merge_new_media(
            options,
            newMediaObject,
            "id"
          );
      ...
      $scope.remove_attribute = function (fieldIndex, key, $index) {
        if (
          $scope.options["fields"][fieldIndex]["general"][key].options.length ==
          1
        ) {
          return;
        }
      ...
      $scope.remove_sub_attribute = function (fieldIndex, opIndex, sopIndex) {
        $scope.options["fields"][fieldIndex]["general"]["attributes"][
          "options"
        ][opIndex]["sub_attributes"].splice(sopIndex, 1);
        $scope.initfieldValue();
      };
      ...
      $scope.seleted_sub_attribute = function (
        ...
        $scope.options["fields"][fieldIndex]["general"][key]["options"][
          opIndex
        ]["sub_attributes"][sopIndex]["selected"] = 1;
        $scope.initfieldValue();
      };
      ...
      $scope.set_component_icon = function (fieldIndex) {
        ...
        file_frame.on("select", function () {
          ...
          $scope.options["fields"][fieldIndex]["general"][
            "component_icon_url"
          ] = url;
          if (
            $scope.$root.$$phase !== "$apply" &&
      ...
      $scope.set_sub_attribute_image = function (
        fieldIndex,
        opIndex,
        sopIndex
      ) {
      ...
      $scope.remove_sub_attribute_image = function (
        ...
        $scope.options["fields"][fieldIndex]["general"]["attributes"][
          "options"
        ][opIndex]["sub_attributes"][sopIndex]["image"] = 0;
        $scope.options["fields"][fieldIndex]["general"]["attributes"][
          "options"
        ][opIndex]["sub_attributes"][sopIndex]["image_url"] = "";
      };
      ...
      $scope.update_price_type = function (fieldIndex) {
        if (
          $scope.options["fields"][fieldIndex]["general"].data_type.value ==
            "m" &&
          $scope.options["fields"][fieldIndex]["general"].price_type.value ==
            "c"
        ) {
          $scope.options["fields"][fieldIndex]["general"].price_type.value =
            "f";
            ...
            switch (field.nbpb_type) {
              case "nbpb_com":
                ...
                if (
                  ...
                  fields[fieldIndex].general.pb_config =
                    field.general.pb_config;
                }
                break;
              case "nbpb_image":
