...
use SPBWC\setasign\Fpdi\PdfParser\CrossReference\CrossReferenceException;
use SPBWC\setasign\Fpdi\PdfParser\Filter\AsciiHex;
 ...
 * @package setasign\Fpdi
 */
class TcpdfFpdi extends \SPBWC\TCPDF
{
    use FpdiTrait {
    ...
    protected function writePdfType(PdfType $value)
    {
        ...
        if ($value instanceof PdfString) {
            ...
            $value->value = \SPBWC\TCPDF_STATIC::_escape($string);
