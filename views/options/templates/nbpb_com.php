                    ...
                    <tr ng-repeat="(vIndex, view) in options.views">
                        ...
                        <td>
                            <div class="image-icon-wrap">
                                ...
                                <img ng-click="set_view_base(vIndex)" ng-src="{{view.base != 0 ? view.base_url : '<?php echo PRINTCART_PB_ASSETS_URL . 'images/placeholder.png' ?>'}}" />
                            </div>
                        </td>
                        <td>
...
<div class="nbd-field-info">
    ...
    <div class="nbd-field-info-2">
        <div class="image-icon-wrap">
            ...
            <img ng-click="set_component_icon(fieldIndex)" ng-src="{{field.general.component_icon != 0 ? field.general.component_icon_url : '<?php echo PRINTCART_PB_ASSETS_URL . 'images/placeholder.png' ?>'}}" />
        </div>
    </div>
</div>
<div class="nbd-field-info">
