    ...
    <div class="nbdl-featured-designer">
        <div class="nbdl-designer-wrap">
            ...
            <?php if( $designer['artist_banner'] ): ?>
                style="background: url('<?php echo esc_url( $designer['artist_banner'] ); ?>') no-repeat center; background-size: cover;"
            <?php endif; ?>
            ></div>
            <div class="nbdl-designer-content">
                <div class="nbdl-designer-name"><a href="<?php echo esc_url( $link_designer ); ?>"><?php echo esc_html( $name ); ?></a></div>
                <?php if( $designer['artist_facebook'] != '' ): ?>
                <div class="nbdl-designer-info">
                    <a href="<?php echo esc_url( $designer['artist_facebook'] ); ?>">
                        <span>
                        ...
                        <?php echo esc_html( $designer['artist_facebook'] ); ?>
                    </a>
                </div>
                <?php endif; ?>
                <?php if( $designer['artist_twitter'] != '' ): ?>
                <div class="nbdl-designer-info">
                    <a href="<?php echo esc_url( $designer['artist_twitter'] ); ?>">
                        <span>
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        ...
                        <?php echo esc_html( $designer['artist_twitter'] ); ?>
                    </a>
                </div>
                <?php endif; ?>
                <?php if( $designer['artist_instagram'] != '' ): ?>
                <div class="nbdl-designer-info">
                    <a href="<?php echo esc_url( $designer['artist_instagram'] ); ?>">
                        <span>
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        ...
                        <?php echo esc_html( $designer['artist_instagram'] ); ?>
                    </a>
                </div>
                <?php endif; ?>
            </div>
            <div class="nbdl-designer-footer">
                <a href="<?php echo esc_url( $link_designer ); ?>" class="nbdl-designer-link"><?php esc_html_e( 'Visit gallery', 'storelly-product-builder-for-woocommerce' ); ?></a>
