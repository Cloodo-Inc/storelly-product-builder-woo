    ...
    <div style="overflow: hidden;">
        <div class="storelly_options_panel" id="storelly-options">
            <p class="storelly-form-field">
                <label for="_storelly_pb_enable"><?php esc_html_e ('Enable Product builder', 'spbwc-product-builder'); ?></label>
            ...
            <p class="storelly-form-field">
                <label>
                    <a href="<?php echo esc_url($link_edit_option); ?>" target="_blank" class="button">
                        <?php if ($option_id != 0) {
                            esc_html_e ('Edit option', 'spbwc-product-builder');
                        } else {
                            esc_html_e ('Create option', 'spbwc-product-builder');
                        }; ?>
                    </a>
                </label>
            </p>
