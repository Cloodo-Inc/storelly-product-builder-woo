...
<div class="pcpb-field-info" ng-show="check_depend(field.general, field.general.attributes)">
    <div class="pcpb-field-info-1">
        <div><label><b><?php esc_html_e('Attributes', 'pc-product-builder'); ?></b> <nbd-tip data-tip="<?php esc_html_e('Attributes let you define extra product data, such as size or color.', 'pc-product-builder'); ?>"></nbd-tip></label></div>
    </div>
        ...
        <div>
            <div ng-repeat="(opIndex, op) in field.general.attributes.options" class="nbd-attribute-wrap">
                <div ng-show="op.isExpand" class="nbd-attribute-img-wrap">
                    <div><?php esc_html_e('Swatch type', 'pc-product-builder'); ?></div>
                    <div>
                        <select ng-model="op.preview_type" style="width: 110px;" name="options[fields][{{fieldIndex}}][general][attributes][options][{{opIndex}}][preview_type]">
                            <option value="i"><?php esc_html_e('Image', 'pc-product-builder'); ?></option>
                            <option value="c"><?php esc_html_e('Color', 'pc-product-builder'); ?></option>
                        </select>
                    </div>
                    <div class="nbd-attribute-img-inner" ng-show="op.preview_type == 'i'">
                        ...
                        <img title="<?php esc_html_e('Click to change image', 'pc-product-builder'); ?>" ng-click="set_attribute_image(fieldIndex, $index, 'image', 'image_url')" ng-src="{{op.image != 0 ? op.image_url : '<?php echo esc_url(SPBWC_PB_ASSETS_URL . 'images/placeholder.png'); ?>'}}" />
                    </div>
                    ...
                    <div ng-if="field.appearance.change_image_product.value == 'y'">
                        <div><?php esc_html_e('Product image', 'pc-product-builder'); ?></div>
                        <div class="nbd-attribute-img-inner">
                            ...
                            <img title="<?php esc_html_e('Click to change image', 'pc-product-builder'); ?>" ng-click="set_attribute_image(fieldIndex, $index, 'product_image', 'product_image_url')" ng-src="{{op.product_image_url ? op.product_image_url : '<?php echo esc_url(SPBWC_PB_ASSETS_URL . 'images/placeholder.png'); ?>'}}" />
                        </div>
                    </div>
                </div>
                <div ng-show="op.isExpand" class="nbd-attribute-content-wrap">
                    <div><?php esc_html_e('Title', 'pc-product-builder'); ?></div>
                    <div class="nbd-attribute-name">
                        ...
                        <label><input type="checkbox" name="options[fields][{{fieldIndex}}][general][attributes][options][{{$index}}][selected]" ng-checked="op.selected" ng-click="seleted_attribute(fieldIndex, 'attributes', $index)" /> <?php esc_html_e('Default', 'pc-product-builder'); ?></label>
                    </div>
                    <div class="nbd-margin-10"></div>
                    <div><?php esc_html_e('Description', 'pc-product-builder'); ?></div>
                    <div class="nbd-attribute-name">
                        <textarea placeholder="<?php esc_html_e('Description', 'pc-product-builder'); ?>" value="{{op.des}}" ng-model="op.des" name="options[fields][{{fieldIndex}}][general][attributes][options][{{opIndex}}][des]"></textarea>
                    </div>
                    <div class="nbd-margin-10"></div>
                    <div><?php esc_html_e('Price', 'pc-product-builder'); ?></div>
                    <div>
                        <div><?php esc_html_e('Additional Price', 'pc-product-builder'); ?></div>
                        <div>
                    ...
                    <div class="nbd-subattributes-wrapper" ng-if="op.enable_subattr === true || op.enable_subattr == 'on'">
                        <div class="pcpb-field-info">
                            <div class="pcpb-field-info-1">
                                <div><label><b><?php esc_html_e('Sub attributes type', 'pc-product-builder'); ?></b></label></div>
                            </div>
                            <div class="pcpb-field-info-2">
                                <div>
                                    <select style="width: 150px;" name="options[fields][{{fieldIndex}}][general][attributes][options][{{$index}}][sattr_display_type]" ng-model="op.sattr_display_type">
                                        <option value="d"><?php esc_html_e('Dropdown', 'pc-product-builder'); ?></option>
                                        <option value="r"><?php esc_html_e('Radio button', 'pc-product-builder'); ?></option>
                                        <option value="s"><?php esc_html_e('Swatch', 'pc-product-builder'); ?></option>
                                        <option value="l"><?php esc_html_e('Label', 'pc-product-builder'); ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div ng-repeat="(sopIndex, sop) in op.sub_attributes" class="nbd-subattributes-wrap">
                            <div ng-show="sop.isExpand" class="nbd-attribute-img-wrap">
                                ...
                                <div class="nbd-attribute-img-inner" ng-show="sop.preview_type == 'i'">
                                    ...
                                    <img title="<?php esc_html_e('Click to change image', 'pc-product-builder'); ?>" ng-click="set_sub_attribute_image(fieldIndex, opIndex, sopIndex)" ng-src="{{sop.image != 0 ? sop.image_url : '<?php echo esc_url(SPBWC_PB_ASSETS_URL . 'images/placeholder.png'); ?>'}}" />
                                </div>
                            ...
                            <div ng-show="sop.isExpand" class="nbd-attribute-content-wrap">
                                ...
                                <div class="nbd-attribute-name">
                                    ...
                                    <label><input type="checkbox" name="options[fields][{{fieldIndex}}][general][attributes][options][{{opIndex}}][sub_attributes][{{sopIndex}}][selected]" ng-checked="sop.selected" ng-click="seleted_sub_attribute(fieldIndex, 'attributes', opIndex, sopIndex)" /> <?php esc_html_e('Default', 'pc-product-builder'); ?></label>
                                </div>
                                <div class="nbd-margin-10"></div>
                                <div><?php esc_html_e('Description', 'pc-product-builder'); ?></div>
                                <div class="nbd-attribute-name">
                                    <textarea placeholder="<?php esc_html_e('Description', 'pc-product-builder'); ?>" value="{{sop.des}}" ng-model="sop.des" name="options[fields][{{fieldIndex}}][general][attributes][options][{{opIndex}}][sub_attributes][{{sopIndex}}][des]"></textarea>
                                </div>
                                <div><?php esc_html_e('Price', 'pc-product-builder'); ?></div>
                                <div>
                                    <div><?php esc_html_e('Additional Price', 'pc-product-builder'); ?></div>
                            ...
                            <div class="nbd-attribute-action">
                                <span class="nbo-sort-group">
                                    <span ng-click="sort_sub_attribute(fieldIndex, opIndex, sopIndex, 'up')" class="dashicons dashicons-arrow-up nbo-sort-up nbo-sort" title="<?php esc_html_e('Up', 'pc-product-builder') ?>"></span>
                                    <span ng-click="sort_sub_attribute(fieldIndex, opIndex, sopIndex, 'down')" class="dashicons dashicons-arrow-down nbo-sort-down nbo-sort" title="<?php esc_html_e('Down', 'pc-product-builder') ?>"></span>
                                </span>
                                <a class="button nbd-mini-btn" ng-click="remove_sub_attribute(fieldIndex, opIndex, sopIndex)" title="<?php esc_html_e('Delete', 'pc-product-builder'); ?>"><span class="dashicons dashicons-no-alt"></span></a>
                                <a class="button nbd-mini-btn" ng-click="toggle_expand_sub_attribute(fieldIndex, opIndex, sopIndex)" title="<?php esc_html_e('Expend', 'pc-product-builder'); ?>">
                        ...
                        <div><a class="button" ng-click="add_sub_attribute(fieldIndex, opIndex)"><span class="dashicons dashicons-plus"></span> <?php esc_html_e('Add sub attribute', 'pc-product-builder'); ?></a></div>
                        <div class="nbd-margin-10"></div>
                    </div>
                </div>
                ...
                <div class="nbd-attribute-action">
                    <span class="nbo-sort-group">
                        <span ng-click="sort_attribute(fieldIndex, $index, 'up')" class="dashicons dashicons-arrow-up nbo-sort-up nbo-sort" title="<?php esc_html_e('Up', 'pc-product-builder') ?>"></span>
                        <span ng-click="sort_attribute(fieldIndex, $index, 'down')" class="dashicons dashicons-arrow-down nbo-sort-down nbo-sort" title="<?php esc_html_e('Down', 'pc-product-builder') ?>"></span>
                    </span>
                    <a class="button nbd-mini-btn" ng-click="remove_attribute(fieldIndex, 'attributes', $index)" title="<?php esc_html_e('Delete', 'pc-product-builder'); ?>"><span class="dashicons dashicons-no-alt"></span></a>
                    <a class="button nbd-mini-btn" ng-click="toggle_expand_attribute(fieldIndex, opIndex)" title="<?php esc_html_e('Expend', 'pc-product-builder'); ?>">
            ...
            <div><a class="button" ng-click="add_attribute(fieldIndex, 'attributes')"><span class="dashicons dashicons-plus"></span> <?php esc_html_e('Add attribute', 'pc-product-builder'); ?></a></div>
        </div>
    </div>
</div>
<?php echo '</script>';
