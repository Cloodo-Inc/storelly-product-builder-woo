...
<div class="pcpb-field-info" ng-show="check_depend(field.general, field.general.published)">
    <div class="pcpb-field-info-1">
        <div><label><b><?php esc_html_e('Published', 'storelly-product-builder-for-woocommerce'); ?></b> <nbd-tip data-tip="<?php esc_html_e('Choose whether the option show in summary options or not.', 'storelly-product-builder-for-woocommerce'); ?>"></nbd-tip></label></div>
    </div>
